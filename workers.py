...
from utils import get_current_timestamp, write_report_file, sleep_with_cancel_check
...
class JobWorker:
    ...
    async def _process_preflight(self, job: Job, repo: JobRepository, payload: Dict[str, Any]):
    ...
    async def _process_fetch(self, job: Job, repo: JobRepository, payload: Dict[str, Any]):
        """Process fetch phase."""
        ...
        logger.info(f"Job {job.job_id}: Fetch phase completed, {len(source_code)} characters fetched")
    
    async def _process_analysis(self, job: Job, repo: JobRepository, payload: Dict[str, Any]):
    ...
    async def _process_llm(self, job: Job, repo: JobRepository, payload: Dict[str, Any]):
        """Process LLM phase."""
    ...
    async def _process_reporting(self, job: Job, repo: JobRepository, payload: Dict[str, Any]):
    ...
    async def _process_final(self, job: Job, repo: JobRepository, payload: Dict[str, Any]):
        """Process final phase."""
