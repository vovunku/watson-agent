...
class AuditAgentClient:
    ...
    def create_job(self, source_code: str, audit_profile: str = "erc20_basic_v1", **kwargs) -> Dict[str, Any]:
        """Create an audit job."""
        payload = {
            "source": {
                "type": "inline",
    ...
    def wait_for_completion(self, job_id: str, timeout: int = 300, poll_interval: int = 2) -> Dict[str, Any]:
        ...
        while time.time() - start_time < timeout:
            ...
            print(f"\rStatus: {job_status:<10} | Phase: {phase:<12} | Progress: {percent:3d}%", end="", flush=True)
