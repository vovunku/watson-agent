...
class Settings(BaseSettings):
    ...
    # Database settings
    db_url: str = Field(default="sqlite:////app/state/agent.db", description="Database URL")
    ...
    job_hard_timeout_sec: int = Field(default=1200, description="Hard timeout for jobs in seconds")
    ...
    # Dry run mode
    dry_run: bool = Field(default=True, description="Enable dry run mode when no API key")
