...
class TestJobRepository:
    ...
    def test_get_job_by_idempotency_key(
        self, test_db_session: Session, sample_job: Job
    ):
    ...
    def test_mark_job_finished(self, test_db_session: Session, sample_job: Job):
        ...
        updated_job = repo.mark_job_finished(
            sample_job.job_id, "succeeded", report_path="/tmp/report.txt"
        )
    ...
    def test_mark_job_finished_with_error(
        self, test_db_session: Session, sample_job: Job
    ):
        ...
        updated_job = repo.mark_job_finished(
            sample_job.job_id, "failed", error_message=error_message
        )
