...
class TestLLMClient:
    ...
    async def test_analyze_code_dry_run(self, llm_client_dry_run):
        ...
        report, metrics = await llm_client_dry_run.analyze_code(code, audit_profile, job_id, payload)
    ...
    async def test_analyze_code_real_api_success(self, llm_client_real):
        ...
        mock_response_data = {
            "choices": [{
                "message": {
                    "content": "Mock audit report content"
                }
            }],
            "usage": {
                "prompt_tokens": 100,
        ...
        with patch.object(llm_client_real.client, 'post') as mock_post:
            ...
            report, metrics = await llm_client_real.analyze_code(code, audit_profile, job_id, payload)
