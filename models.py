...
class Job(Base):
    ...
    status = Column(String(20), nullable=False, index=True)  # queued, running, succeeded, failed, canceled, expired
    ...
    progress_phase = Column(String(20), nullable=False, default="preflight")  # preflight, fetch, analysis, llm, reporting, final
